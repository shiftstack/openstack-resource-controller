...
func (actuator portActuator) GetOSResourceByID(ctx context.Context, id string) (*ports.Port, progress.ReconcileStatus) {
...
func (actuator portActuator) CreateResource(ctx context.Context, obj *orcv1alpha1.Port) (*ports.Port, progress.ReconcileStatus) {
...
func (actuator portActuator) DeleteResource(ctx context.Context, _ *orcv1alpha1.Port, flavor *ports.Port) progress.ReconcileStatus {
